...
SRC_URI = "git://github.com/golang/oauth2;name=oauth2 \
           git://github.com/GoogleCloudPlatform/gcloud-golang;name=cloud;destsuffix=${GO_SRCROOT}/vendor/google.golang.org/cloud \
           git://github.com/grpc/grpc-go;name=grpc;destsuffix=${GO_SRCROOT}/vendor/google.golang.org/grpc"
